...
public class ConsumerMain {
    ...
    private static Consumer<String, String> createConsumer() {
        ...
        properties.put("key.deserializer", StringSerializer.class.getName()); //消息的key的反序列化方式
        properties.put("value.deserializer", StringSerializer.class.getName());   //消息的value的反序列化方式
