...
public class ZhenYouUtil {
	...
	public static JSONObject createZhiBo(String token, String contactId, String userName) {
		JSONObject o = new JSONObject();
		o.put("appointment", 0);
		o.put("contactDisplayName", userName + "的"+DateUtil.getTime()+"直播");
		o.put("contactId", contactId);
		o.put("createTime", DateUtil.getShijianCuo());
		o.put("desc", userName + "的"+DateUtil.getTime()+"直播");
		o.put("dvrCount", 0);
		o.put("playCount", 0);
		o.put("status", 0);
		o.put("title", userName + "的"+DateUtil.getTime()+"直播");
